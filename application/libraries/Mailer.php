...
class Mailer 
{
    ...
    function mail_template($to = '',$slug = '',$mail_data = '')
    {
        ...
        $template =  $this->CI->load->view('admin/email_templates/preview', $data,true);
	...
	//=============================================================
	function pwd_reset_link($username, $reset_link, $sitename)
	{
		$tpl = '<h3>Hi ' .strtoupper($username).'</h3>
            <p>Welcome to ' .strtoupper($sitename).'!</p>
