...
$('.upload_attachmentfile').on('change', function(){
	...
	$.ajax({
                url: base_url+'admin/chat-attachment/upload', 
                dataType: 'json',  
                cache: false,
                contentType: false,
                processData: false,
	...
	var Sender_ProfilePic = $('#Sender_ProfilePic').val();
		...
		var str = '<div class="convo-box pull-right">';
				str+='<div class="convo-area pull-right">';
				 ...
				 str+='<div class="convo-img"><img class="img-fluid rounded" src="'+base_url+'public/uploads/admin/'+Sender_ProfilePic+'" alt="image">';
				 str+='</div>'
				 str+='</div></div>';
		$('#dumppy').append(str);
}
